    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-lg">
        ...
        <form action="{{ route('posts.update', $post->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea id="content" name="content" rows="6" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ $post->content }}</textarea>
            </div>
